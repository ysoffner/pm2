...
var daemonize = function (conf, infos, cb) {
  ...
  child.once('message', function (msg) {
    ...
    if (msg.error === true) {
      ...
      return cb(msg);
    } else if (msg.km_data.disabled === true) {
      ...
      return cb(msg);
    } else if (msg.km_data.error === true) {
...
InteractorDaemonizer.getOrSetConf = function (cst, infos, cb) {
  ...
  configuration.machine_name = infos.info_node || confFS.machine_name || os.hostname();
  ...
  configuration.info_node = infos.public_key && !confFS.info_node
      ? process.env.KEYMETRICS_NODE || cst.KEYMETRICS_ROOT_URL : confFS.info_node || cst.KEYMETRICS_ROOT_URL;
